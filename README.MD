...
* createXSLT.xql Ð XQuery Script to automatically generate MEI-2010to2012.xsl by comparing old and new element names and matching those where only capitalization differs.
